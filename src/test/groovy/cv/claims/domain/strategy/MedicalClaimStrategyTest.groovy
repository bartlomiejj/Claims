...
class MedicalClaimStrategyTest extends Specification {

    @Subject
    MedicalClaimStrategy sub
    ...
    def "should sort claims"() {
        ...
        sortedClaims[1].claimId() == claim2.claimId()
        sortedClaims[2].claimId() == claim1.claimId()
